...
python src/infer.py \
	            --dataset               torc \
	            --data_dir              /nas/EOS/users/anush/cvpr_torc/torc/ \
                    --gt_dir                /nas/EOS-DB/users/aman/data/RelativePose/groundtruth_json_poses \
		    --splits_dir            /nas/EOS/users/anush/single-shot/eos_multiview_pose/src/data/split_files/cvpr_videos/torc/wk2/CAPT-199/ \
                    --log_dir               /nas/EOS/users/anush/logs \
                    --height                512 \
                    --width                 1024 \
                    --exp_num               101 \
                    --exp_name              suppl_infer \
                    --exp_metainfo          torc_6D_CAPT-199 \
                    --batch_size            1 \
                    --num_workers           12 \
		    --pose_repr		    use_6D \
                    --rotation              1e+02 \
