...
python src/train.py \
		    ...
		    --load_weights_folder   /nas/EOS/users/anush/logs/hsm_debug/exp-67_kitti_rectify_lr_2e-5_192x640/models/weights_51 \
		    ...
		    --dataset               kitti \
                    ...
                    --exp_num               67 \
                    --exp_name              hsm_debug \
                    --exp_metainfo          kitti_rectify_lr_2e-5_192x640 \
                    --batch_size            10 \
                    --num_workers           4 \
		    --pose_repr		    use_rectify \
                    --rotation              1e+02 \
                    --learning_rate         2e-05 \
                    --model_name            hsm \
                    --num_epochs            80 \
