...
python src/train.py \
		    ...
		    --load_weights_folder   /home/anush/logs/hsm_debug/exp-74_kitti_9D_seq_dispimg_rectvol_lr_2e-5_192x640/models/weights_17 \
		    --dataset               kitti \
                    --height                192 \
                    --width                 640 \
                    --exp_num               74 \
                    --exp_name              hsm_debug \
                    --exp_metainfo          kitti_9D_seq_dispimg_rectvol_lr_2e-5_192x640 \
                    --batch_size            8 \
                    --num_workers           4 \
		    --pose_repr		    use_9D \
                    --rotation              1e+02 \
