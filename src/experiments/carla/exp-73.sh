...
python src/train.py \
		    ...
		    --load_weights_folder   /home/anush/logs/hsm_debug/exp-73_kitti_9D_revseq_dispimg_lr_2e-5_192x640/models/weights_0 \
		    --dataset               kitti \
                    --height                192 \
                    --width                 640 \
                    --exp_num               73 \
                    --exp_name              hsm_debug \
                    --exp_metainfo          kitti_9D_revseq_dispimg_lr_2e-5_192x640 \
                    --batch_size            8 \
                    --num_workers           4 \
		    --pose_repr		    use_9D \
                    --rotation              1e+02 \
