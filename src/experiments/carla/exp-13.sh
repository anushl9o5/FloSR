...
python src/train.py --data_dir              /nas/EOS/users/siva/data/carla_data/simulations/rand_weather_camera_pert_2/night_Town06 \
		    ...
		    --load_weights_folder /nas/EOS/users/anush/logs/stereo_pose_estimation/exp-13_siamese_6D_carla_lr_0.00002_subset_radial_mask_512x1024/models/weights_79 \
                    ...
                    --exp_metainfo          siamese_6D_carla_lr_0.00002_subset_radial_mask_512x1024 \
                    --batch_size            1 \
                    --num_workers           2 \
                    --rotation              1e+02 \
                    --learning_rate         2e-05 \
