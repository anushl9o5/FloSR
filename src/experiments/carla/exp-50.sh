...
python src/train.py --data_dir              /nas/EOS/users/aman/data/RelativePose/frames \
		    ...
		    --load_weights_folder   /nas/EOS/users/anush/logs/hsm_debug/exp-50_sterepose_9D_lr_2e-5_perturb_0.2_optflow_576x768/models/weights_6/ \
		    --splits_dir            src/data/split_files/algolux \
                    ...
                    --exp_num               50 \
                    --exp_name              hsm_debug \
                    --exp_metainfo          sterepose_9D_lr_2e-5_perturb_0.2_optflow_576x768 \
                    --batch_size            8 \
                    --num_workers           4 \
