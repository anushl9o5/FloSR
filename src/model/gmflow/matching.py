...
def global_correlation_softmax(feature0, feature1,
    ...
    grid = init_grid.view(b, 2, h*w).permute(0, 2, 1)  # [B, H*W, 1]
    ...
    return prob.view(b, h, w, h, w), correspondence
...
def local_correlation_softmax(feature0, feature1, local_radius,
    ...
    coords_init = coords_grid(b, h, w).to(feature0.device)  # [B, 1, H, W]
    coords = coords_init.view(b, 2, -1).permute(0, 2, 1)  # [B, H*W, 1]
