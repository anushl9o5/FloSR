...
from utility.data_utils import calibrate_stereo_pair_torch, gram_schmidt, svd_orthogonalize
        ...
        **kwargs,
        ...
        for scale_idx in range(self.num_scales):
            ...
            if not self.ablate_init:
                feature0_rectf, feature1_rectf = self.rectify_feats(
                    feature0,
                    feature1,
                    R,
                    translation,
            ...
            if not self.ablate_transformer:
                ...
                feature0, feature1 = feature_add_position(
                    feature0_rectf, feature1_rectf, attn_splits, self.feature_channels
                )
