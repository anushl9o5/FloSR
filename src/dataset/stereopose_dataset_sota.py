...
class StereoPoseDatasetSOTA(data.Dataset):
    ...
    def __init__(self, pose_gt_dir,
        ...
        super(StereoPoseDatasetSOTA,self).__init__()
    ...
    def __getitem__(self, index):
        ...
        sota = {'dnet': "/home/eos/workspace/code/DirectionNet/torc_experiments/pred_poses", #"/nas/EOS/users/anush/DirectionNet/final_model/pred_poses", 
