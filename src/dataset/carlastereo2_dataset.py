...
class CarlaStereoPose2Dataset(data.Dataset):
    def __init__(
        self,
        pose_gt_dir,
        frames_dir,
    ...
    def __getitem__(self, index):
        ...
        target_cam_num, ref_cam_num, left_frame_path, right_frame_path, calib_path = self.data[index]
        ...
        pose_json_fpath = os.path.join(calib_path)
        ...
        if self.resize_orig_img:
            resize_width, resize_height = 1280, 704
