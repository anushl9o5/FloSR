...
class KITTIDatasetSOTA(data.Dataset):
    ...
    def __init__(self, pose_gt_dir,
        ...
        super(KITTIDatasetSOTA, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        if self.is_flip:
            ...
            K_right, dist_right = np.array(self.pose_gt["K_02"]).reshape(3,3), np.array(self.pose_gt["D_02"]).reshape(-1)
        else:
        ...
        sota = {'dnet': "/nas/EOS/users/anush/DirectionNet/kitti_experiments/pred_poses", #"/nas/EOS/users/anush/DirectionNet/final_model/pred_poses", 
